...
$s = " select * from manager where username = '$username' ";
...
$num = mysqli_num_rows($result);
	...
	if($num == 1){ //checks whether any person with the same username exists or not
		...
		$query = " insert into manager (firstname,lastname,username,contact,email,password,confirmp) values ('$fname', '$lname', '$username', '$contact', '$email', '$pass', '$confp') ";
